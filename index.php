...
<head>
  ...
  <title>Taman Edukasi Keselamatan Jalan "Anak Bangsa" Purwokerto</title>
  <!--Bootstrap -->
...
<body>
        ...
        <div class="row">
          <div class="col-md-5 col-md-push-7">
            ...
            <style>
              ...
              <h1>Taman Edukasi Keselamatan Jalan</h1>

              <a href="#resentnewcar" class="btn">DAFTAR SEKARANG<span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
            </div>
          </div>
        </div>
      </div>
  ...
  <script>
    $(document).ready(function() {
      // Mengatur efek scroll halus ketika menu "Book Now" diklik
